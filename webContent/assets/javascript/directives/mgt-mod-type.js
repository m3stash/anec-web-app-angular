...
angular.module('page-mgt-mod-type', [])
  .directive('mgtModType', function ($http, agGridConf, $filter, glbFac, Modules_type) {
    return {
      restrict:'E',
      controllerAs: 'mgt_mt',
      scope: {},
      ...
      controller: function myCtrl(){
        ...
        thiz.loadGridData = function(id){
          ...
          if(_.isUndefined(id)){
            ...
            Modules_type.get({ idModule: id}, function(res) {
              thiz.gridOptions.api.setRowData(res.moduleTypeList);
              var idSelect = id;
            }, function(err) {
              //err
            });
